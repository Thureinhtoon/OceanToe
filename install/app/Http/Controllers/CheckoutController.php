...
//         foreach(Township::all() as $key => $to){
//            for($i=0;$i<count($address);$i++){
//               dd( $address[$i]);
//             if ($to->name === $address[$i]->township_name) {
//                 $delivery = $to->delivery_price;
//                  dd($address[$i]->township_name);
// }

//            }
          

//         if ($to->name === $address->township_name) {
//     $delivery += $to->delivery_price;
//     dd($delivery);
// }


//             dd($to->delivery_price);
//         }
//         dd($address[3]['township_name']);
