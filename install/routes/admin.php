...
Route::get('/township','TownshipController@index')->name('township');
...
Route::get('township/{id}/edit', 'TownshipController@edit')->name('township.edit');

Route::post('township/{id}/update', 'TownshipController@update')->name('township.update');

Route::delete('township/{id}/delete', 'TownshipController@destroy')->name('township.delete');
